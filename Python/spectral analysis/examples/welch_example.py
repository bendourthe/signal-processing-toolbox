...
# Load data
data = sio.loadmat('eeg_sample.mat')

# Allocate variables from data set
signal = data['eegdata'][0]
sampling_rate = data['srate'][0]
...
plotting = 1
#   function
welch_power = welch_method(signal, sampling_rate=sampling_rate, window=window, overlap=overlap, plotting=plotting);
